...
namespace TouchWater
{
	public static class Clippy
	{
		...
		public static void Paste(ObservableCollection<string> str) {
			Paste(string.Join("\n", str));
		}
	}

	// Credit: https://github.com/MrM40/W-WinClipboard/blob/main/Main.cs
	// Credit: https://github.com/CopyText/TextCopy
	// License, MIT
